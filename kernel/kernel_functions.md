...
```
[TARGET GPU] = gfx900 , gfx803 or gfx701
[INPUT FILE] = Name of the file containing kernels
[OUTPUT FILE] = Name of the generated code object file
```

Note that one important fact to remember when using binary code objects is
that the number of arguments to the kernel are different on HCC and NVCC path.

### ROCM Enabled GPUS.


| **Product** | **APU** | **TargetCode** | **Officially Supported** |
| --- | --- | --- |---|
| FirePro -- W8100, W9100, S9150, S9170|  | gfx701 | |
| Radeon -- R9 290, R9 290x, R390 R390x |  | gfx702 ||
| A10-8700P,  Pro A10-8700B,  A10-8780P| ✓ | gfx801 ||
| FirePro -- S7150, S7100, W7100;Radeon -- R285, R9 380, R9 385; FirePro (Mobile) -- M7170 |  | gfx802 ||
| Radeon -- R9 Nano, R9 Fury, R9 FuryX, Pro Duo,Instinct MI8;FirePro -- S9300x2|  | gfx803 |✓|
| Radeon -- RX 470, RX 460, RX 480, RX 560, RX 570, RX 580, RX 590, Instinct MI6 | |  gfx803 |✓|
| Radeon -- Vega FE, Vega 64,Vega 56, Instinct MI25 | |  gfx900 |✓|
| Radeon Pro -- WX8200,WX9100,V340,V340 MxGPU | |  gfx900 |✓|
| Radeon -- Vega VII||couldn't find it|✓|
